 ...
 *
 * Translates input commands into ReferenceFrame updates (translation and rotation).
 * Replaces msd-gui::CameraController with simulation-appropriate implementation.
 *
 * Supports frame-rate independent movement through delta-time scaling.
 * Movement is applied in the local coordinate frame of the provided ReferenceFrame.
 *

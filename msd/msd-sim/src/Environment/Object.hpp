 ...
 *
 * Frame hierarchy:
 * 1. Local frame: Object vertices are constant in this frame
 * 2. Global frame: Object's local frame is positioned within global frame
...
public:
   ...
   */
  Object(const std::vector<Coordinate>& localVertices,
...
private:
  ...
  std::vector<Coordinate> localVertices_;
  ...
  std::vector<Coordinate> viewerFrameVertices_;

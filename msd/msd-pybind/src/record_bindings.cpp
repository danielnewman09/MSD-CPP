...
void bind_records(py::module_& m)
{
  ...
  // Replaces ContactConstraintRecord + FrictionConstraintRecord with a single
  // unified record that carries all contact geometry, friction direction, and
  // solved lambda values.
  py::class_<msd_transfer::UnifiedContactConstraintRecord>(m, "UnifiedContactConstraintRecord")
    .def(py::init<>())
    .def_readonly("id", &msd_transfer::UnifiedContactConstraintRecord::id)
    .def_readonly("body_a_id", &msd_transfer::UnifiedContactConstraintRecord::body_a_id)
    .def_readonly("body_b_id", &msd_transfer::UnifiedContactConstraintRecord::body_b_id)
    .def_readonly("normal", &msd_transfer::UnifiedContactConstraintRecord::normal)
    .def_readonly("lever_arm_a", &msd_transfer::UnifiedContactConstraintRecord::lever_arm_a)
    .def_readonly("lever_arm_b", &msd_transfer::UnifiedContactConstraintRecord::lever_arm_b)
    .def_readonly("penetration_depth", &msd_transfer::UnifiedContactConstraintRecord::penetration_depth)
    .def_readonly("restitution", &msd_transfer::UnifiedContactConstraintRecord::restitution)
    .def_readonly("pre_impact_rel_vel_normal", &msd_transfer::UnifiedContactConstraintRecord::pre_impact_rel_vel_normal)
    .def_readonly("tangent1", &msd_transfer::UnifiedContactConstraintRecord::tangent1)
    .def_readonly("tangent2", &msd_transfer::UnifiedContactConstraintRecord::tangent2)
    .def_readonly("friction_coefficient", &msd_transfer::UnifiedContactConstraintRecord::friction_coefficient)
    .def_readonly("normal_lambda", &msd_transfer::UnifiedContactConstraintRecord::normal_lambda)
    .def_readonly("tangent1_lambda", &msd_transfer::UnifiedContactConstraintRecord::tangent1_lambda)
    .def_readonly("tangent2_lambda", &msd_transfer::UnifiedContactConstraintRecord::tangent2_lambda)
    .def_property_readonly("frame_id", [](msd_transfer::UnifiedContactConstraintRecord const& r) { return r.frame.id; })
    ;
}
